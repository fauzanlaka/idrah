<?php
    ...
    if($u_status=='Admin' || $u_status=='Kewangan'){
?>
<div class="page-title">
    <div>
        <h1><i class="fa fa-file-code-o"></i> INFO MAHASISWA</h1>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"><i class="fa fa-file-code-o"></i> INFO MAHASISWA</h3>
            <form class="form-horizontal" name="search" id="search">
                <input type="text" class="form-control" name="q" id="q" placeholder="Cari" onkeyup="student_search('module/student/action/search.php', 'search')" onkeypress="return student_search_enter('module/scoreCenter/action/search.php', 'search')">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="#" onclick="formLoad('module/student/person.php', '<?= $st_id ?>', '<?= $operator ?>')"><button class="btn btn-success btn-sm"><i class="fa fa-folder-open-o"></i> lihat</button></a></td>
                        </tr>
                        <?php
                            }
                        ?>
