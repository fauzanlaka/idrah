    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-horizontal" name="search" id="search">
                <input type="text" class="form-control" name="q" id="q" placeholder="Cari" onkeyup="student_search('module/scoreCenter/action/search.php', 'search')" onkeypress="return student_search_enter('module/scoreCenter/action/search.php', 'search')">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="#" onclick="formLoad('module/scoreCenter/personScore.php', '<?= $st_id ?>', '<?= $operator ?>')"><button class="btn btn-success btn-sm"><i class="fa fa-folder-open-o"></i> lihat</button></a></td>
                        </tr>
                        <?php
                            }
                        ?>
