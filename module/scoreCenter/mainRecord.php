...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"><i class="fa fa-file-code-o"></i> REKOD HASIL</h3>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <select name="ft_id" id="ft_id" class="form-control" onchange="facultySelect('../connect/connect.php')">
                              ...
                              <?php
                              $get_ft_id = userInfo($operator, 'ft_id', $connect);
                              $faculty = mysqli_query($con, "SELECT * FROM fakultys WHERE ft_id='$get_ft_id'");
        ...
        <div align="center">
            <button class="btn btn-success" onclick="classTimetableSearch_record()"><span class="glyphicon glyphicon-search"></span> Cari</button>
        </div>
        <br>
        <div id="msg"></div>
    </div>
